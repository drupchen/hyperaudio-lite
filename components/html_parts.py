...
body_beginning = dedent("""\
      <body>
          <p style="font-size: 36pt; text-align: center;">༄༅། །ལམ་རིམ་བདུད་རྩི་སྙིང་པོ་དང་། དེའི་འགྲེལ་ཆུང་ཚིག་དོན་རབ་གསལ་གྱི་ལྗགས་ཁྲིད། རྗེ་བླ་མ་དིལ་མཁྱེན་རྡོ་རྗེ་འཆང་གི་གསུང་བཞུགས།།</p>
          <p style="font-size: 50%;">
          Press the "Play" button to start playing the audio. The transcription will follow the audio.
          <br>You can also click anywhere on the text (except where there is a background color) to bring the audio to that point.
          <br><br>
          Legend: <br>
