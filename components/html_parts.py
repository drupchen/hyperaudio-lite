...
body_beginning = dedent("""\
      <body>
          ...
          <div class="content">
              ...
              Legend:
              <ul>
                <li>"<font class="unsure">༺དོགས་པ་ཡོད་ས།༻ ༺&#60;transcription I'm unsure about&#62;༻</font>"</li>
                <li>"<font class="hesit">༼བཞག་ན་ཆོག་པའི་གསུངས་།༽ ༼&#60;hesitations or repetitions that can be ignored&#62;༽</font>"</li>
                <li>"<font class="changed">ཚེག་བར་࿏ རྟགས་ཅན་ནི་སྒྲ་ཇི་བཞིན་མེད། &#60;changed-syllable&#62;࿏་</font>"</li>
              </ul>
